...
class MainActivity : View.OnClickListener, AppCompatActivity() {
    ...
    var apkUrl:String = "http://test.optthis.com/1.1.2.apk"
    var patshJson:String = "{\"preVersion\": \"1.1.1\",  \"patchUrl\": \"http://test.optthis.com/1.1.2.patch\", \"preVersionApkNameMd5\": \"972df38636d1fa82c62a28c639444b5c\",  \"currentVersionApkNameMd5\":\"54e59c56965aec266cbfb4eef3553fba\",\"patchNameMd5\": \"bc907548f3e5f30b71742e7ea6d74c01\"}"
    ...
    override fun onClick(v: View?) {
        ...
        when (v?.id) {
            R.id.btn_download_apk -> consume {
                ...
                PatchApi.downloadPatch(apkUrl,"com.test.opt",13,patshJson, patch = object : IPatch {
            ...
            R.id.btn_merge_apk -> consume {
                var oldFilePath = "/storage/emulated/0/Download/matt/download/origin/opt1.1.1.apk"
                var newFilePath = "/storage/emulated/0/Download/matt/download/opt1.1.2.apk"
                var patchPath = "/storage/emulated/0/Download/matt/download/opt1.1.2.patch"
